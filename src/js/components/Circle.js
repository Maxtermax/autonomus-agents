...
export default class Circle extends Motion {
  constructor({ ctx, speedUp = true, targets = [],  maxVelocity = 0, stroke = false, size = 20, canvas, debug = false, mass = 40, forces = [], x = 0, y = 0, angle = 0, velocity = 0, acceleration = 0, color = 'white', id = physicsEngine.guid(), display = true }) {
    super({ ctx, canvas, speedUp, mass, x, y, maxVelocity, targets });
    this.size = size;
    this.stroke = stroke;
    this.color = color;
    this.id = id;
